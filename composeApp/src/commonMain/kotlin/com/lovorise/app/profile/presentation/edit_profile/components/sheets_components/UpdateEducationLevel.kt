...
import coinui.composeapp.generated.resources.what_is_you_education_level
...
@Composable
fun UpdateEducationLevelSheetContent(
    education: EditProfileScreenState.EducationLevel,
    isDarkMode:Boolean,
    onSave:(Int)->Unit,
    updateEducation:(EditProfileScreenState.EducationLevel)->Unit,
    buttonText:String = stringResource(Res.string.save)
) {


    var isButtonEnabled by remember { mutableStateOf(false) }
    var isVisible by remember { mutableStateOf(education.isVisible) }
    var selectedIndex by remember { mutableIntStateOf(education.selectedIndex) }
    ...
    Column {
        Column(
            ...
            Icon(
                imageVector = vectorResource(Res.drawable.ic_education),
            ...
            Text(
                ...
                text = stringResource(Res.string.what_is_you_education_level),
            ...
            FlowRow(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp), verticalArrangement = Arrangement.spacedBy(10.dp)){
                education.items.forEachIndexed { index, value ->
                    ElevatedChipItem(
                        text = value,
            ...
            ButtonWithText(
                ...
                onClick = {
                    if (isButtonEnabled) {
                        updateEducation(education.copy(selectedIndex = selectedIndex, isVisible = isVisible))
