...
import coinui.composeapp.generated.resources.what_you_want_in_family_planning
...
@Composable
fun UpdateFamilyPlanningSheetContent(
    familyPlanning: EditProfileScreenState.FamilyPlanning,
    isDarkMode:Boolean,
    onSave:(Int)->Unit,
    updateFamilyPlanning:(EditProfileScreenState.FamilyPlanning)->Unit,
    ...
    var isVisible by remember { mutableStateOf(familyPlanning.isVisible) }
    var selectedIndex by remember { mutableIntStateOf(familyPlanning.selectedIndex) }
    ...
    Column {
        Column(
            ...
            Icon(
                imageVector = vectorResource(Res.drawable.ic_family_planning),
            ...
            Text(
                ...
                text = stringResource(Res.string.what_you_want_in_family_planning),
            ...
            FlowRow(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp), verticalArrangement = Arrangement.spacedBy(10.dp)){
                familyPlanning.items.forEachIndexed { index, value ->
                    ElevatedChipItem(
                        text = value,
            ...
            ButtonWithText(
                ...
                onClick = {
                    if (isButtonEnabled) {
                        updateFamilyPlanning(familyPlanning.copy(selectedIndex = selectedIndex, isVisible = isVisible))
