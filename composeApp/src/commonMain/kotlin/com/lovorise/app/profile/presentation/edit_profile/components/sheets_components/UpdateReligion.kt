...
@Composable
fun UpdateReligionSheetContent(
    religion: EditProfileScreenState.Religion,
    isDarkMode:Boolean,
    onSave:(Int)->Unit,
    updateReligion:(EditProfileScreenState.Religion)->Unit,
    ...
    var isVisible by remember { mutableStateOf(religion.isVisible) }
    var selectedIndex by remember { mutableIntStateOf(religion.selectedIndex) }
    ...
    Column {
        Column(
            ...
            FlowRow(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp), verticalArrangement = Arrangement.spacedBy(10.dp)){
                religion.items.forEachIndexed { index, value ->
                    ElevatedChipItem(
                        text = value,
            ...
            ButtonWithText(
                ...
                onClick = {
                    if (isButtonEnabled) {
                        updateReligion(religion.copy(selectedIndex = selectedIndex, isVisible = isVisible))
