package com.lovorise.app.accounts.presentation.signup.dating_prefs
...
import coinui.composeapp.generated.resources.what_do_you_want_from_your_meet
...
class DatingPreferenceScreen : Screen{
    ...
    override fun Content() {
        ...
        LaunchedEffect(true){
            accountsViewModel.setSignupPage(SignupFlowPages.DATING_PREFS_SCREEN,ctx)
        }

        DatingPreferenceScreenContent(
            isDarkMode = isDarkMode,
            navigateToChooseInterestsScreen = {
                navigator.push(ChooseInterestsScreen())
            },
            goBack = {
...
@Composable
fun DatingPreferenceScreenContent(
    isDarkMode:Boolean,
    navigateToChooseInterestsScreen:()->Unit,
    goBack:()->Unit,
    accountsViewModel: AccountsViewModel
) {

    val categories = stringArrayResource(Res.array.dating_preferences)
//    val isEnabled by remember { mutableStateOf(true) }
    var selectedGenders by remember { mutableStateOf(listOf<String>()) }
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = stringResource(Res.string.what_do_you_want_from_your_meet),
            ...
            Text(
                modifier = Modifier.align(Alignment.Start),
                text = stringResource(Res.string.choose_option_that_feels_right),
                fontFamily = PoppinsFontFamily(),
            ...
            ButtonWithText(
                ...
                onClick = {
                    if (selectedGenders.isNotEmpty()) {
                        accountsViewModel.addDatingPref(selectedGenders)
                    }else{
                        navigateToChooseInterestsScreen()
                    }
                }
