package com.lovorise.app.accounts.presentation.signup.education_level
...
class EducationLevelScreen : Screen{
    ...
    override fun Content() {
        ...
        LaunchedEffect(true){
            accountsViewModel.setSignupPage(SignupFlowPages.EDUCATION_LEVEL_SCREEN,ctx)
        }

        EducationLevelScreenContent(
            ...
            onSkip = {
                navigator.push(FamilyPlanningScreen())
            },
            onNext = {
                navigator.push(FamilyPlanningScreen())
            },
...
@Composable
fun EducationLevelScreenContent(
    isDarkMode:Boolean,
    goBack:()->Unit,
    onSkip:()->Unit,
    onNext:()->Unit,
    ...
    val res = stringArrayResource(Res.array.education_levels)
            ...
            ButtonWithText(
                ...
                onClick = {
                    if (isEnabled && selectedIndex >= 0) {
                        accountsViewModel.addEducationLevel(items[selectedIndex])
                    }
                }
            )
