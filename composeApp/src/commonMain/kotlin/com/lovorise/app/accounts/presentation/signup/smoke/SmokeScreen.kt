package com.lovorise.app.accounts.presentation.signup.smoke
...
import coinui.composeapp.generated.resources.how_often_you_smoke
...
class SmokeScreen : Screen {
    ...
    override fun Content() {
        ...
        LaunchedEffect(true){
            accountsViewModel.setSignupPage(SignupFlowPages.SMOKE_SCREEN,ctx)
        }
...
fun SmokeScreenContent(
    ...
    val res = stringArrayResource(Res.array.smoking_preferences)
    ...
    Column(
        ...
        Column(
            ...
            Icon(
                imageVector = vectorResource(Res.drawable.ic_smoke),
                contentDescription = null,
            ...
            Text(
                text = stringResource(Res.string.how_often_you_smoke),
            ...
            ButtonWithText(
                ...
                onClick = {
                    if (isEnabled && selectedIndex >= 0) {
                        accountsViewModel.addSmoke(items[selectedIndex])
                    }
                }
            )
