package com.lovorise.app.accounts.presentation.signup.religion
...
import coinui.composeapp.generated.resources.ic_religion
...
import coinui.composeapp.generated.resources.what_is_your_religion
...
class ReligionScreen : Screen {
    ...
    override fun Content() {
        ...
        LaunchedEffect(true){
            accountsViewModel.setSignupPage(SignupFlowPages.RELIGION_SCREEN,ctx)
        }

        ReligionScreenContent(
...
fun ReligionScreenContent(
    ...
    val res = stringArrayResource(Res.array.religions)
    ...
    Column(
        ...
        Column(
            ...
            Icon(
                imageVector = vectorResource(Res.drawable.ic_religion),
                contentDescription = null,
            ...
            Text(
                text = stringResource(Res.string.what_is_your_religion),
            ...
            ButtonWithText(
                ...
                bgColor = if (isEnabled && selectedIndex >= 0) Color(0xffF33358) else if (isDarkMode) DISABLED_DARK else DISABLED_LIGHT,
                textColor = if (isEnabled && selectedIndex >= 0) Color.White else if (isDarkMode) DISABLED_TEXT_DARK else DISABLED_TEXT_LIGHT,
                onClick = {
                    if (isEnabled && selectedIndex >= 0) {
                        accountsViewModel.addReligion(items[selectedIndex])
                    }
                }
            )
