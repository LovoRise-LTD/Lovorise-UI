package com.lovorise.app.libs.audio.waveform
        ...
        modifier = Modifier
            ...
            .pointerInput(Unit) {
                awaitEachGesture {
                    ...
                    if (down.position.x in 0f..width) {
                        onProgressChange(down.position.x / width)
                    }

                    drag(down.id) { change ->
                        if (change.position.x in 0f..width) {
                            onProgressChange(change.position.x / width)
                            change.consume()
                        }
                    }
