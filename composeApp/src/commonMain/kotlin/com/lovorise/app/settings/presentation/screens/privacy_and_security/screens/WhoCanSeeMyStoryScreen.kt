...
import coinui.composeapp.generated.resources.set_this_for_all_profile
import coinui.composeapp.generated.resources.who_can_see_my_story
...
class WhoCanSeeMyStoryScreen : Screen {
...
@Composable
fun WhoCanSeeMyStoryScreenContent(isDarkMode: Boolean, goBack:()-> Unit,state: PrivacyAndSecurityState,screenModel: PrivacyAndSecurityScreenModel,onAddPerson:()-> Unit){
    ...
    Column(modifier = Modifier.background(if (isDarkMode) BASE_DARK else Color.White)) {
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(Res.string.who_can_see_my_story),
            ...
            PrivacyTextWithCheckbox(
                text = "Everybody",
                isChecked = state.story.privacyOption == PrivacyOptions.EVERYBODY,
                onClick = {
                    screenModel.updateStoryPrivacy(state.story.copy(privacyOption = PrivacyOptions.EVERYBODY))
                }
            )
            ...
            PrivacyTextWithCheckbox(
                text = "Likes & Matches",
                isChecked = state.story.privacyOption == PrivacyOptions.LIKES_AND_MATCHES,
                onClick = {
                    screenModel.updateStoryPrivacy(state.story.copy(privacyOption = PrivacyOptions.LIKES_AND_MATCHES))
                }
            )
            Spacer(Modifier.height(8.dp))
            ...
            PrivacyTextWithCheckbox(
                text = "Matches only",
                isChecked = state.story.privacyOption == PrivacyOptions.MATCHES_ONLY,
                onClick = {
                    screenModel.updateStoryPrivacy(state.story.copy(privacyOption = PrivacyOptions.MATCHES_ONLY))
                }
            )
            Spacer(Modifier.height(8.dp))
            ...
            PrivacyTextWithCheckbox(
                text = "Nobody",
                isChecked = state.story.privacyOption == PrivacyOptions.NOBODY,
                onClick = {
                    screenModel.updateStoryPrivacy(state.story.copy(privacyOption = PrivacyOptions.NOBODY))
                }
            )
            ...
            SetThisPrivacyForAllProfile(isChecked = true, isDarkMode = isDarkMode, onClick = {})
...
@Composable
fun SetThisPrivacyForAllProfile(isChecked: Boolean,isDarkMode: Boolean,onClick:()-> Unit){
    Row(
        modifier = Modifier.fillMaxWidth()
            .height(39.dp)
        ...
        Text(
            modifier = Modifier.weight(1f),
            text = stringResource(Res.string.set_this_for_all_profile),
            fontFamily = PoppinsFontFamily(),
            fontWeight = FontWeight.Medium,
            fontSize = 14.sp,
            letterSpacing = 0.2.sp,
