...
import coinui.composeapp.generated.resources.who_can_see_my_location
...
import coinui.composeapp.generated.resources.your_selection_applies_to_both
...
class ReadReceiptScreen : Screen {
...
@Composable
fun ReadReceiptScreenContent(isDarkMode: Boolean, goBack:()-> Unit,state: PrivacyAndSecurityState,screenModel: PrivacyAndSecurityScreenModel,onAddPerson:()-> Unit){
    ...
    Column(modifier = Modifier.background(if (isDarkMode) BASE_DARK else Color.White)) {
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(Res.string.read_receipts),
            ...
            Text(
                modifier = Modifier.padding(horizontal = 16.dp),
                text = stringResource(Res.string.your_selection_applies_to_both),
            ...
            PrivacyTextWithCheckbox(
                text = "Everybody",
                isChecked = state.location.privacyOption == PrivacyOptions.EVERYBODY,
                onClick = {
                    screenModel.updateLocation(state.location.copy(privacyOption = PrivacyOptions.EVERYBODY))
                }
            )
            Spacer(Modifier.height(8.dp))
            ...
            PrivacyTextWithCheckbox(
                text = "Likes & Matches",
                isChecked = state.location.privacyOption == PrivacyOptions.LIKES_AND_MATCHES,
                onClick = {
                    screenModel.updateLocation(state.location.copy(privacyOption = PrivacyOptions.LIKES_AND_MATCHES))
                }
            )
            Spacer(Modifier.height(8.dp))
            ...
            PrivacyTextWithCheckbox(
                text = "Matches only",
                isChecked = state.location.privacyOption == PrivacyOptions.MATCHES_ONLY,
                onClick = {
                    screenModel.updateLocation(state.location.copy(privacyOption = PrivacyOptions.MATCHES_ONLY))
                }
            )
            Spacer(Modifier.height(8.dp))
            ...
            PrivacyTextWithCheckbox(
                text = "Nobody",
                isChecked = state.location.privacyOption == PrivacyOptions.NOBODY,
                onClick = {
                    screenModel.updateLocation(state.location.copy(privacyOption = PrivacyOptions.NOBODY))
                }
            )
