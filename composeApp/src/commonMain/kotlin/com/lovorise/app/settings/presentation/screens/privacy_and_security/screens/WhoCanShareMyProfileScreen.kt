...
import coinui.composeapp.generated.resources.who_can_share_my_profile
...
class WhoCanShareMyProfileScreen : Screen {
    ...
    override fun Content() {
        ...
        WhoCanShareMyProfileScreenContent(
...
@Composable
fun WhoCanShareMyProfileScreenContent(isDarkMode: Boolean, goBack:()-> Unit,state: PrivacyAndSecurityState,screenModel: PrivacyAndSecurityScreenModel,onAddPerson:()-> Unit){
    ...
    Column(modifier = Modifier.background(if (isDarkMode) BASE_DARK else Color.White)) {
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(Res.string.who_can_share_my_profile),
            ...
            PrivacyTextWithCheckbox(
                text = "Everybody",
                isChecked = state.shareProfile.privacyOption == PrivacyOptions.EVERYBODY,
                onClick = {
                    screenModel.updateShareProfilePrivacy(state.shareProfile.copy(privacyOption = PrivacyOptions.EVERYBODY))
                }
            )
            ...
            PrivacyTextWithCheckbox(
                text = "Likes & Matches",
                isChecked = state.shareProfile.privacyOption == PrivacyOptions.LIKES_AND_MATCHES,
                onClick = {
                    screenModel.updateShareProfilePrivacy(state.shareProfile.copy(privacyOption = PrivacyOptions.LIKES_AND_MATCHES))
                }
            )
            Spacer(Modifier.height(8.dp))
            ...
            PrivacyTextWithCheckbox(
                text = "Matches only",
                isChecked = state.shareProfile.privacyOption == PrivacyOptions.MATCHES_ONLY,
                onClick = {
                    screenModel.updateShareProfilePrivacy(state.shareProfile.copy(privacyOption = PrivacyOptions.MATCHES_ONLY))
                }
            )
            Spacer(Modifier.height(8.dp))
            ...
            PrivacyTextWithCheckbox(
                text = "Nobody",
                isChecked = state.shareProfile.privacyOption == PrivacyOptions.NOBODY,
                onClick = {
                    screenModel.updateShareProfilePrivacy(state.shareProfile.copy(privacyOption = PrivacyOptions.NOBODY))
                }
            )
