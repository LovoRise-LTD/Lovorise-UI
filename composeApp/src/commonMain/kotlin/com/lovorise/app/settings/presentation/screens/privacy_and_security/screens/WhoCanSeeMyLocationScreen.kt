...
class WhoCanSeeMyLocationScreen : Screen {
    ...
    override fun Content() {
        ...
        WhoCanSeeMyLocationScreenContent(
...
@Composable
fun WhoCanSeeMyLocationScreenContent(isDarkMode: Boolean, goBack:()-> Unit,state: PrivacyAndSecurityState,screenModel: PrivacyAndSecurityScreenModel,onAddPerson:()-> Unit){
    ...
    Column(modifier = Modifier.background(if (isDarkMode) BASE_DARK else Color.White)) {
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(Res.string.who_can_see_my_location),
