...
import coinui.composeapp.generated.resources.add_recovery_email
...
import coinui.composeapp.generated.resources.secure_your_account
import coinui.composeapp.generated.resources.your_recovery_email_ensures_you_never_loose_access
...
class AddRecoveryEmailScreen : Screen {
    ...
    override fun Content() {
        ...
        AddRecoveryEmailScreenContent(
            isDarkMode = isDarkMode,
            goBack = {
                navigator.pop()
            },
            navigateToVerifyRecoveryEmail = {
                navigator.push(VerifyRecoveryEmail(it))
            }
        )
    }
}
...
@Composable
fun AddRecoveryEmailScreenContent(isDarkMode:Boolean,goBack:()->Unit,navigateToVerifyRecoveryEmail:(String)->Unit) {
    ...
    Column(modifier = Modifier
        ...
        Column(
            ...
            HeaderWithTitleAndBack(title = stringResource(Res.string.add_recovery_email), onBack = goBack, isDarkMode = isDarkMode)
            ...
            Column(
                ...
                Text(
                    modifier = Modifier.fillMaxWidth().align(Alignment.Start),
                    text = stringResource(Res.string.your_recovery_email_ensures_you_never_loose_access),
                    fontFamily = PoppinsFontFamily(),
                    ...
                    onClick = {
                        if (isEnabled) {
                            if (!isEmailValid(email)){
                                ...
                                keyboardController?.hide()
                                navigateToVerifyRecoveryEmail(email)
                            }
                        }
                    }
                )
