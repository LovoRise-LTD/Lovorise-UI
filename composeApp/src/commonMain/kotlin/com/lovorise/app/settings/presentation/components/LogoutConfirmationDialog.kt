...
import coinui.composeapp.generated.resources.do_you_want_to_logout_now
...
@Composable
fun LogoutConfirmationDialog(onLogout:()->Unit,onCancel:()->Unit,isDarkMode:Boolean) {
    ...
    Dialog(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = stringResource(Res.string.do_you_want_to_logout_now),
